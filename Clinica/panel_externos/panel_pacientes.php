...
$id_interno=$_SESSION['id_externo'];
...
<button id="btnEditar" type="button" class="btn btn-danger" onclick="location.href='cerrar_cuenta_don.php'"><i class="fas fa-users"></i> Asignar Usuario Externo </button>    
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formPersonas" action="save_notificacion.php" method="POST">    
            <div class="modal-body">
                ...
                <input type="hidden" class="form-control" name="id_interno" value="<?php echo $id_interno; ?>">
